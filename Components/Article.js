  ...
  return (
    <div className="text-left">
      ...
      <div className="font_bis">
        <div className="text-lg font_bis font-semibold">
        ...
        <div className="mt-6 flex items-center">
          <div className="w-7/12">
            ...
            <div className="mt-6 mb-2 text-xl font-bold uppercase">
              Type de site
            </div>
            <div className=" text-lg font_bis">
          ...
          <div className="w-5/12 ml-4 flex justify-center items-center">
            <img src="/images/mockup-OVH.png" alt="" className="" />
          </div>
        </div>
        <div className="mt-6 flex items-center">
          <div className="w-5/12 mr-4 pr-4 flex justify-center items-center">
            <img src="/images/maquette-site-internet.jpg" alt="" className="" />
          </div>
          <div className="w-7/12">
            <div className="mb-2 text-xl font-bold uppercase">
        ...
        <div className="mt-6 flex items-center">
          ...
          <div className="w-5/12 ml-4 pl-4 flex justify-center items-center">
            <img src="/images/webmaster-maintenance.jpg" alt="" className="" />
          </div>
        </div>
