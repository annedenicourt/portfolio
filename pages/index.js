        ...
        <div className="container bg-white">
          ...
          <div className="row mt-5 mx-2 mx-lg-5" id="presentation">
            <div className="col col-md-10 mx-auto mt-5 text-center">
              ...
              <div className="fs-5">
                Développeuse web au parcours atypique, je me suis engagée dans
                cette voie professionnelle avant tout par passion. Quoi de plus
                grisant et de plus stimulant que de créer un site, de le faire
                fonctionner et de chercher des solutions lorsqu’un problème
                apparaît ? <br />
            ...
            {/* Section PROJETS */}
            <div
              className="row mx-0 mt-5 d-flex flex-column flex-md-row justify-content-center"
              id="projets"
            >
              <h2 className="mt-5 pt-5 fs-1 fw-bold text-center">
                MES PROJETS
              </h2>
              ...
              <div className="mb-5 text-center fs-5">
                Quelques projets réalisés lors de ma formation... <br />
                en attendant avec impatience ceux à venir !
              </div>
              <div className="mb-5 text-center fs-4 fw-bold">
                PROJETS DE FORMATION
              </div>
              {projects
                .filter((project) => project.category === "scool")
                .map((project) => (
                  <div
                    className="col col-md-5 mb-5 text-center"
                    key={project.id}
                  >
                    <CardProject
                      id={project.id}
          ...
          <div className="row m-0 d-flex flex-column flex-md-row" id="contact">
            ...
            <div className="col col-lg-8 mx-auto p-2 mt-5 mb-5">
              ...
              <div className="mb-5 text-center fw-bold fs-4">
                06 29 71 78 72
              </div>
              <Form />
            </div>
