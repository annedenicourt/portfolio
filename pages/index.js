    ...
    <div className="container bg-white">
        ...
        <div className="row m-0">
            <div className="col-9 mx-auto pt-5 text-center">
                ...
                <Link href="#section1"><button className="animate-bounce button-scroll mt-5"><i className="bi bi-arrow-down-circle-fill fs-1 p-2"></i></button></Link>
            </div>
        </div>
        <div className="row m-0" id="section1">
            <div className="col col-lg-10 mx-auto text-center">
        ...
        <div className="row m-0" id="section2">
        ...
        <div className="row m-0" id="section3">
            <div className="col mx-auto text-center">
